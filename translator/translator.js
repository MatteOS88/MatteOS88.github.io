const translateWord = ['embed', 'plumber', 'velocity', 'disgrace', 'barely', 'capable', 'awe', 'withdraw', 'former', 'insult', 'stubborn', 'semicolon', 'inevitable', 'plain', 'otherwise', 'well', 'bank', 'wipe', 'overwhelming'];
const polishWord = ['osadzać', 'hydraulik', 'prędkość', 'hańba', 'ledwo', 'zdolny', 'groza', 'wycofać', 'były', 'zniewaga', 'uparty', 'średnik', 'nieunikniony', 'równina', 'inaczej', 'studnia', 'brzeg', 'wycierać', 'przytłaczający'];
